...
import addNewTaxiService from "../../redux/services/TaxiService/addNew";
import editTaxiService from "../../redux/services/TaxiService/editOne";

import styles from "./index.module.css";

function CreateTaxiService(props) {
  const { taxiServices, serviceToEdit } = useSelector(
    (rootReducer) => rootReducer.taxiServices
  );
  ...
  const onSubmit = (data) => {
    const service = id
      ...
      : {
          ...
          tariffPlan: data.tariffPlan,
          id: taxiServices.length + 1,
          nextPayment: data.nextPayment,
        };
    dispatch(id ? editTaxiService(service) : addNewTaxiService(service));
    props.history.push("/");
  };
      ...
      <Box className={styles.wrapper}>
        <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
          ...
          {/* <div className={styles.buttons}>
            ...
            <Link className={styles.margin} to="/">
              <Button
...
export default CreateTaxiService;
